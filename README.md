...
Following you can find a picture to hardware based in stlink and  blue pill which are sold in aliexpress.

![gcc](https://github.com/lord-feistel/bluepill_pirate/blob/main/images/fake_blue_pill.jpeg)

Within this repository, you will find how to configure your environment using only free software e.g. GDB, GCC, and Vscode to avoid the illegal usage of the  STM Cube IDE ( Hardware Abstraction Layer ) 

In parallel we will generate a cleaner code since the STM cube generates loads of useless code.

Another concern is that the C++ code generated by the STM32 cube IDE  doesn't use C++ features.

Within this repository, you will also find an example code using C++ showing and how to configure registers based on the datasheet information to get the hardware working.
